...
mysql_query("INSERT INTO comentarios SET name='".$user."', comentarios='".$comment."' , dia='".date('d')."' , mes='".date('m')."', anio='".date('Y')."' , ip_post='".$_SERVER['REMOTE_ADDR']."' , publicado='Publicado' , fecha='".date('Y-m-d')."'  " .$addon);
