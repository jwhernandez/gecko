                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="">
                                <a data-toggle="tab" href="#edit-profile">
                                    <i class="glyphicon glyphicon-pencil"></i> Actualizar perfil
                                </a>
                            </li>
                        </ul>
                    </header>
                                    ...
                                    <div id="disponibles">
                                        <?php $database = new DBAccess();
                                            try
                                            {
                                                ...
                                                $sql = "SELECT * FROM ge_experiences WHERE EXP_SUSID='".$_SESSION['userId']."' ORDER BY EXP_DATE DESC";
                                                    ...
                                                    <label class="col-sm-12 col-xs-12">
                                                        <div class="act-time">
                                                            <div class="activity-body act-in">
                                                                ...
                                                                <div class="text">
                                                                    <a href="#" class="activity-img"><img class="avatar" src="<?php echo $_SESSION['userImage'] ?>" alt=""></a>
                                                                    <p class="attribution">
                                                                        <a href="#"><?php echo $_SESSION['user']." ".$_SESSION['userSFirth']." ".$_SESSION['userSSecond']?></a>
                                                                        <?php
                                                                            setlocale(LC_ALL,"es_ES@euro","es_ES","esp");
                                    ...
                                    <div class="panel-body bio-graph-info">
                                        <form method="post" action="account.php" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="subject" class="control-label col-sm-2">Nombre:</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="nombre" class="form-control" name="nombre" value="<?php echo $_SESSION['user'] ?>">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="textinput">P. Apellido</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="Primer Apellido" class="form-control" name="ape1" value="<?php echo $_SESSION['userSFirth'] ?>">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="textinput">S. Apellido</label>
                                                <div class="col-sm-10">
                                                    <input type="text" placeholder="Segundo Apellido" class="form-control" name="ape2" value="<?php echo $_SESSION['userSSecond'] ?>">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="email" class="form-control" placeholder="Email" value="<?php echo $_SESSION['userEmail'] ?>">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="textinput">Fecha Nacimiento:</label>
                                                <div class="col-sm-10">
                                                    <input type="date" name="edad" class="form-control" value="<?php echo $_SESSION['userBirth'] ?>">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label" for="textinput">Foto de perfil</label>
                                                <div class="col-sm-10">
                                                    <input id="file-3" type="file" multiple=true name="image[]">
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="submit" name="subir" value="Actualizar" class="btn btn-primary" />
                                                    </br>
                                                    </br>
                                                </div>
                                            </div>                        
